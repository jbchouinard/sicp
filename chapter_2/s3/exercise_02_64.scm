...
; and list of at least n elements and constructs a balanced tree containing the
; first n elements of the list. The result returned by partial-tree is a pair
...
; The tree produced will be:
; (5 (1 () (3 () ())) (9 (7 () ()) (11 () ())))

(define test-list '(1 3 5 7 9 11))
(define test-result (list->tree test-list))

; b. What is the order of growth in the number of steps required by list->tree
; to convert a list of n elements?

; Ultimately, a couple of arithmetic operations and a cons are executed
; for each entry in the list; the number of steps is O(n).
