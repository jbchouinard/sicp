; SICP Huffman Encoding Package
; Currently this package does not actually implement Huffman encoding.
...
; It produces trees that are almost but not quite Huffman trees.
